...
local add_biome = function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o)
	...
	minetest.register_biome({
		...
		y_min = l,
		y_max = m,
		vertical_blend = lib_ecology.biome_vertical_blend,
		heat_point = n,
		humidity_point = o,
	})
...
local add_biomes_hot_humid = function()
	...
	add_biome("hot_humid_coastal", nil, "lib_materials:dirt_with_grass_hot_humid_coastal", 1, "lib_materials:dirt_silt_02", 6, "lib_materials:stone_basalt_01", nil, nil, nil, nil, 2, lib_ecology.maxheight_coastal, lib_ecology.temperature_hot, lib_ecology.humidity_humid)
	add_biome("hot_humid_lowland", nil, "lib_materials:dirt_with_grass_hot_humid_lowland", 1, "lib_materials:dirt_silty", 5, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_hot, lib_ecology.humidity_humid)
	add_biome("hot_humid_shelf", nil, "lib_materials:dirt_with_grass_hot_humid_shelf", 1, "lib_materials:dirt_dark", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_hot, lib_ecology.humidity_humid)
	add_biome("hot_humid_highland", nil, "lib_materials:dirt_with_grass_hot_humid_highland", 1, "lib_materials:dirt", 3, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_hot, lib_ecology.humidity_humid)
...
local add_biomes_hot_semihumid = function()
	...
	add_biome("hot_semihumid_coastal", nil, "lib_materials:dirt_with_grass_hot_semihumid_coastal", 1, "lib_materials:dirt_silty", 6, "lib_materials:stone_basalt_01", nil, nil, nil, nil, 0, lib_ecology.maxheight_coastal, lib_ecology.temperature_hot, lib_ecology.humidity_semihumid)
	add_biome("hot_semihumid_lowland", nil, "lib_materials:dirt_with_grass_hot_semihumid_lowland", 1, "lib_materials:dirt_dark", 5, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_hot, lib_ecology.humidity_semihumid)
	add_biome("hot_semihumid_shelf", nil, "lib_materials:dirt_with_grass_hot_semihumid_shelf", 1, "lib_materials:dirt", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_hot, lib_ecology.humidity_semihumid)
	add_biome("hot_semihumid_highland", nil, "lib_materials:dirt_with_grass_hot_semihumid_highland", 1, "lib_materials:dirt_coarse", 3, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_hot, lib_ecology.humidity_semihumid)
...
local add_biomes_hot_temperate = function()
	...
	add_biome("hot_temperate_coastal", nil, "lib_materials:dirt_with_grass_hot_temperate_coastal", 1, "lib_materials:dirt_dark", 6, "lib_materials:stone_brown", nil, nil, nil, nil, lib_ecology.maxheight_beach, lib_ecology.maxheight_coastal, lib_ecology.temperature_hot, lib_ecology.humidity_temperate)
	add_biome("hot_temperate_lowland", nil, "lib_materials:dirt_with_grass_hot_temperate_lowland", 1, "lib_materials:dirt", 5, "lib_materials:stone_brown", nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_hot, lib_ecology.humidity_temperate)
	add_biome("hot_temperate_shelf", nil, "lib_materials:dirt_with_grass_hot_temperate_shelf", 1, "lib_materials:dirt_coarse", 4, "lib_materials:stone_brown", nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_hot, lib_ecology.humidity_temperate)
	add_biome("hot_temperate_highland", nil, "lib_materials:dirt_with_grass_hot_temperate_highland", 1, "lib_materials:dirt_clay_red", 3, "lib_materials:stone_brown", nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_hot, lib_ecology.humidity_temperate)
...
local add_biomes_hot_semiarid = function()
	...
	add_biome("hot_semiarid_beach", nil, "lib_materials:sand_beach", 1, "lib_materials:dirt_clayey", 4, "lib_materials:stone_sand", nil, nil, nil, nil, -4, 4, lib_ecology.temperature_hot, lib_ecology.humidity_semiarid)
	...
	add_biome("hot_semiarid_coastal", nil, "lib_materials:dirt_with_grass_hot_semiarid_coastal", 1, "lib_materials:dirt", 6, "lib_materials:stone_sand", nil, nil, nil, nil, lib_ecology.maxheight_beach, lib_ecology.maxheight_coastal, lib_ecology.temperature_hot, lib_ecology.humidity_semiarid)
	add_biome("hot_semiarid_lowland", nil, "lib_materials:dirt_with_grass_hot_semiarid_lowland", 1, "lib_materials:dirt_coarse", 5, "lib_materials:stone_sand", nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_hot, lib_ecology.humidity_semiarid)
	add_biome("hot_semiarid_shelf", nil, "lib_materials:dirt_with_grass_hot_semiarid_shelf", 1, "lib_materials:dirt_clay_red", 4, "lib_materials:stone_sand", nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_hot, lib_ecology.humidity_semiarid)
	add_biome("hot_semiarid_highland", nil, "lib_materials:dirt_with_grass_hot_semiarid_highland", 1, "lib_materials:dirt_clayey", 3, "lib_materials:stone_sand", nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_hot, lib_ecology.humidity_semiarid)
...
local add_biomes_hot_arid = function()
	...
	add_biome("hot_arid_beach", nil, "lib_materials:sand_white", 1, "lib_materials:dirt_clay_red", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, -4, 4, lib_ecology.temperature_hot, lib_ecology.humidity_arid)

	add_biome("hot_arid_coastal", nil, "lib_materials:stone_sandstone_white_gravel", 5, "lib_materials:stone_brown", 10, "lib_materials:stone_basalt_01", nil, nil, nil, "lib_materials:dirt_clay_white", lib_ecology.maxheight_beach, lib_ecology.maxheight_coastal, lib_ecology.temperature_hot, lib_ecology.humidity_arid)
	add_biome("hot_arid_lowland", nil, "lib_materials:stone_sandstone_white_gravel", 10, "lib_materials:stone_sand", 15, "lib_materials:stone_brown", nil, nil, nil, "lib_materials:dirt_clay_white", lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_hot, lib_ecology.humidity_arid)
	add_biome("hot_arid_shelf", nil, "lib_materials:stone_sandstone_white_gravel", 10, "lib_materials:stone_desert", 20, "lib_materials:stone_sand", nil, nil, nil, "lib_materials:dirt_clay_white", lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_hot, lib_ecology.humidity_arid)
	add_biome("hot_arid_highland", nil, "lib_materials:stone_sandstone_white_gravel", 15, "lib_materials:stone_sandstone_desert", 25, "lib_materials:stone_desert", nil, nil, nil, "lib_materials:dirt_clay_white", lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_hot, lib_ecology.humidity_arid)

	add_biome("hot_arid_mountain", nil, "lib_materials:stone_sandstone_white", 10, "lib_materials:stone_brown", 20, "lib_materials:stone_desert", nil, nil, nil, nil, lib_ecology.maxheight_highland, lib_ecology.maxheight_mountain, lib_ecology.temperature_hot, lib_ecology.humidity_arid)
...
local add_biomes_warm_humid = function()
	...
	add_biome("warm_humid_coastal", nil, "lib_materials:dirt_with_grass_warm_humid_coastal", 1, "lib_materials:dirt_silt_02", 6, "lib_materials:stone_basalt_01", nil, nil, nil, nil, -3, lib_ecology.maxheight_coastal, lib_ecology.temperature_warm, lib_ecology.humidity_humid)
	add_biome("warm_humid_lowland", nil, "lib_materials:dirt_with_grass_warm_humid_lowland", 1, "lib_materials:dirt_silty", 5, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_warm, lib_ecology.humidity_humid)
	add_biome("warm_humid_shelf", nil, "lib_materials:dirt_with_grass_warm_humid_shelf", 1, "lib_materials:dirt_dark", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_warm, lib_ecology.humidity_humid)
	add_biome("warm_humid_highland", nil, "lib_materials:dirt_with_grass_warm_humid_highland", 1, "lib_materials:dirt", 3, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_warm, lib_ecology.humidity_humid)
...
local add_biomes_warm_semihumid = function()
	...
	add_biome("warm_semihumid_coastal", nil, "lib_materials:dirt_with_grass_warm_semihumid_coastal", 1, "lib_materials:dirt_silty", 6, "lib_materials:stone_brown", nil, nil, nil, nil, -lib_ecology.maxheight_beach, lib_ecology.maxheight_coastal, lib_ecology.temperature_warm, lib_ecology.humidity_semihumid)
	add_biome("warm_semihumid_lowland", nil, "lib_materials:dirt_with_grass_warm_semihumid_lowland", 1, "lib_materials:dirt", 5, "lib_materials:stone_brown", nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_warm, lib_ecology.humidity_semihumid)
	add_biome("warm_semihumid_shelf", nil, "lib_materials:dirt_with_grass_warm_semihumid_shelf", 1, "lib_materials:dirt_coarse", 4, "lib_materials:stone_brown", nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_warm, lib_ecology.humidity_semihumid)
	add_biome("warm_semihumid_highland", nil, "lib_materials:dirt_with_grass_warm_semihumid_highland", 1, "lib_materials:dirt_dry", 3, "lib_materials:stone_brown", nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_warm, lib_ecology.humidity_semihumid)
...
local add_biomes_warm_temperate = function()
	...
	add_biome("warm_temperate_beach", nil, "lib_materials:sand_beach", 1, "lib_materials:sand", 4, nil, nil, nil, nil, nil, -4, 4, lib_ecology.temperature_warm, lib_ecology.humidity_temperate)
	...
	add_biome("warm_temperate_coastal", nil, "lib_materials:dirt_with_grass_warm_temperate_coastal", 1, "lib_materials:dirt_dark", 6, "lib_materials:stone_limestone_01", nil, nil, nil, nil, lib_ecology.maxheight_beach, lib_ecology.maxheight_coastal, lib_ecology.temperature_warm, lib_ecology.humidity_temperate)
	add_biome("warm_temperate_lowland", nil, "lib_materials:dirt_with_grass_warm_temperate_lowland", 1, "lib_materials:dirt", 5, "lib_materials:stone_limestone_01", nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_warm, lib_ecology.humidity_temperate)
	add_biome("warm_temperate_shelf", nil, "lib_materials:dirt_with_grass_warm_temperate_shelf", 1, "lib_materials:dirt_coarse", 4, "lib_materials:stone_limestone_01", nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_warm, lib_ecology.humidity_temperate)
	add_biome("warm_temperate_highland", nil, "lib_materials:dirt_with_grass_warm_temperate_highland", 1, "lib_materials:dirt_clay_red", 3, "lib_materials:stone_limestone_01", nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_warm, lib_ecology.humidity_temperate)
...
local add_biomes_warm_semiarid = function()
	...
	add_biome("warm_semiarid_beach", nil, "lib_materials:sand_beach", 1, "lib_materials:sand", 4, nil, nil, nil, nil, nil, -4, 4, lib_ecology.temperature_warm, lib_ecology.humidity_semiarid)
	...
	add_biome("warm_semiarid_coastal", nil, "lib_materials:dirt_with_grass_warm_semiarid_coastal", 1, "lib_materials:dirt", 4, "lib_materials:stone_desert", nil, nil, nil, nil, lib_ecology.maxheight_beach, lib_ecology.maxheight_coastal, lib_ecology.temperature_warm, lib_ecology.humidity_semiarid)
	add_biome("warm_semiarid_lowland", nil, "lib_materials:dirt_with_grass_warm_semiarid_lowland", 1, "lib_materials:dirt_coarse", 4, "lib_materials:stone_desert", nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_warm, lib_ecology.humidity_semiarid)
	add_biome("warm_semiarid_shelf", nil, "lib_materials:dirt_with_grass_warm_semiarid_shelf", 1, "lib_materials:dirt_clay_red", 4, "lib_materials:stone_desert", nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_warm, lib_ecology.humidity_semiarid)
	add_biome("warm_semiarid_highland", nil, "lib_materials:dirt_with_grass_warm_semiarid_highland", 1, "lib_materials:dirt_clayey", 4, "lib_materials:stone_desert", nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_warm, lib_ecology.humidity_semiarid)
...
add_biome("warm_arid_beach", nil, "lib_materials:stone_sandstone_desert_gravel", 1, "lib_materials:sand", 4, nil, nil, nil, nil, nil, -4, 4, lib_ecology.temperature_warm, lib_ecology.humidity_arid)
...
local add_biomes_temperate_humid = function()
	...
	add_biome("temperate_humid_beach", nil, "lib_materials:sand_beach", 2, "default:sand", 4, "lib_materials:stone_sandstone", nil, nil, nil, nil, -4, 4, lib_ecology.temperature_temperate, lib_ecology.humidity_humid)
	...
	add_biome("temperate_humid_coastal", nil, "lib_materials:dirt_with_grass_temperate_humid_coastal", 1, "lib_materials:dirt_silt_01", 6, "lib_materials:stone_brown", nil, nil, nil, nil, -lib_ecology.maxheight_beach, lib_ecology.maxheight_coastal, lib_ecology.temperature_temperate, lib_ecology.humidity_humid)
	add_biome("temperate_humid_lowland", nil, "lib_materials:dirt_with_grass_temperate_humid_lowland", 1, "lib_materials:dirt_silty", 5, "lib_materials:stone_brown", nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_temperate, lib_ecology.humidity_humid)
	add_biome("temperate_humid_shelf", nil, "lib_materials:dirt_with_grass_temperate_humid_shelf", 1, "lib_materials:dirt_dark", 4, "lib_materials:stone_brown", nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_temperate, lib_ecology.humidity_humid)
	add_biome("temperate_humid_highland", nil, "lib_materials:dirt_with_grass_temperate_humid_highland", 1, "lib_materials:dirt", 3, "lib_materials:stone_brown", nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_temperate, lib_ecology.humidity_humid)
...
local add_biomes_temperate_semihumid = function()
	...
	add_biome("temperate_semihumid_beach", nil, "lib_materials:sand_beach", 1, "lib_materials:sand", 4, nil, nil, nil, nil, nil, -4, 4, lib_ecology.temperature_temperate, lib_ecology.humidity_semihumid)
	...
	-- add_biome("temperate_semihumid_shelf", nil, "lib_materials:dirt_with_grass3", 1, "lib_materials:dirt", 4, nil, nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_temperate, lib_ecology.humidity_semihumid)
	...
	add_biome("temperate_semihumid_coastal", nil, "lib_materials:dirt_with_grass_temperate_semihumid_coastal", 1, "lib_materials:dirt_silty", 4, nil, nil, nil, nil, nil, lib_ecology.maxheight_beach, lib_ecology.maxheight_coastal, lib_ecology.temperature_temperate, lib_ecology.humidity_semihumid)
	add_biome("temperate_semihumid_lowland", nil, "lib_materials:dirt_with_grass_temperate_semihumid_lowland", 1, "lib_materials:dirt_dark", 4, nil, nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_temperate, lib_ecology.humidity_semihumid)
	add_biome("temperate_semihumid_shelf", nil, "lib_materials:dirt_with_grass_temperate_semihumid_shelf", 1, "lib_materials:dirt", 4, nil, nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_temperate, lib_ecology.humidity_semihumid)
	add_biome("temperate_semihumid_highland", nil, "lib_materials:dirt_with_grass_temperate_semihumid_highland", 1, "lib_materials:dirt_clay_red", 4, nil, nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_temperate, lib_ecology.humidity_semihumid)
...
local add_biomes_temperate_temperate = function()
	...
	add_biome("temperate_temperate_beach", nil, "lib_materials:sand_beach", 1, "lib_materials:sand", 4, nil, nil, nil, nil, nil, -4, 4, lib_ecology.temperature_temperate, lib_ecology.humidity_temperate)
	...
	add_biome("temperate_temperate_coastal", nil, "lib_materials:dirt_with_grass_temperate_temperate_coastal", 1, "lib_materials:dirt_dark", 4, "lib_materials:stone_limestone_01", nil, nil, nil, nil, lib_ecology.maxheight_beach, lib_ecology.maxheight_coastal, lib_ecology.temperature_temperate, lib_ecology.humidity_temperate)
	add_biome("temperate_temperate_lowland", nil, "lib_materials:dirt_with_grass_temperate_temperate_lowland", 1, "lib_materials:dirt", 4, "lib_materials:stone_limestone_01", nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_temperate, lib_ecology.humidity_temperate)
	add_biome("temperate_temperate_shelf", nil, "lib_materials:dirt_with_grass_temperate_temperate_shelf", 1, "lib_materials:dirt_coarse", 4, "lib_materials:stone_limestone_01", nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_temperate, lib_ecology.humidity_temperate)
	add_biome("temperate_temperate_highland", nil, "lib_materials:dirt_with_grass_temperate_temperate_highland", 1, "lib_materials:dirt_clay_red", 4, "lib_materials:stone_limestone_01", nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_temperate, lib_ecology.humidity_temperate)
	...
	add_biome("temperate_temperate_strato", "default:snowblock", "lib_materials:stone_basalt_02", 15, "lib_materials:stone_greenstone", 25, "lib_materials:stone_schist", nil, nil, nil, nil, lib_ecology.minheight_snow, lib_ecology.maxheight_snow, lib_ecology.temperature_temperate, lib_ecology.humidity_temperate)
...
local add_biomes_temperate_semiarid = function()
	...
	add_biome("temperate_semiarid_beach", nil, "lib_materials:sand_beach", 1, "lib_materials:sand", 4, nil, nil, nil, nil, nil, -4, 4, lib_ecology.temperature_temperate, lib_ecology.humidity_semiarid)
	...
	add_biome("temperate_semiarid_coastal", nil, "lib_materials:dirt_with_grass_temperate_semiarid_coastal", 1, "lib_materials:dirt", 4, nil, nil, nil, nil, nil, lib_ecology.maxheight_beach, lib_ecology.maxheight_coastal, lib_ecology.temperature_temperate, lib_ecology.humidity_semiarid)
	add_biome("temperate_semiarid_lowland", nil, "lib_materials:dirt_with_grass_temperate_semiarid_lowland", 1, "lib_materials:dirt_coarse", 4, nil, nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_temperate, lib_ecology.humidity_semiarid)
	add_biome("temperate_semiarid_shelf", nil, "lib_materials:dirt_with_grass_temperate_semiarid_shelf", 1, "lib_materials:dirt_clay_red", 4, nil, nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_temperate, lib_ecology.humidity_semiarid)
	add_biome("temperate_semiarid_highland", nil, "lib_materials:dirt_with_grass_temperate_semiarid_highland", 1, "lib_materials:dirt_clayey", 4, nil, nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_temperate, lib_ecology.humidity_semiarid)
...
add_biome("temperate_arid_beach", nil, "lib_materials:sand_beach", 1, "lib_materials:sand", 4, nil, nil, nil, nil, nil, -4, 4, lib_ecology.temperature_temperate, lib_ecology.humidity_arid)
...
add_biome("temperate_arid_lowland", nil, "lib_materials:dirt_dry", 4, "lib_materials:stone_sand", 6, "lib_materials:stone_brown", nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_temperate, lib_ecology.humidity_arid)
...
add_biome("temperate_arid_highland", nil, "lib_materials:dirt_sandy", 2, "lib_materials:stone_sandstone_desert", 10, "lib_materials:stone_desert", nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_temperate, lib_ecology.humidity_arid)
...
local add_biomes_cool_humid = function()
	...
	add_biome("cool_humid_beach", nil, "lib_materials:sand_beach", 1, "default:sand", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, -4, 4, lib_ecology.temperature_cool, lib_ecology.humidity_humid)
	...
	add_biome("cool_humid_coastal", nil, "lib_materials:dirt_with_grass_cool_humid_coastal", 1, "lib_materials:dirt_silt_02", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_beach, lib_ecology.maxheight_coastal, lib_ecology.temperature_cool, lib_ecology.humidity_humid)
	add_biome("cool_humid_lowland", nil, "lib_materials:dirt_with_grass_cool_humid_lowland", 1, "lib_materials:dirt_silty", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_cool, lib_ecology.humidity_humid)
	add_biome("cool_humid_shelf", nil, "lib_materials:dirt_with_grass_cool_humid_shelf", 1, "lib_materials:dirt_dark", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_cool, lib_ecology.humidity_humid)
	add_biome("cool_humid_highland", nil, "lib_materials:dirt_with_grass_cool_humid_highland", 1, "lib_materials:dirt", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_cool, lib_ecology.humidity_humid)
...
local add_biomes_cool_semihumid = function()
	...
	add_biome("cool_semihumid_beach", nil, "lib_materials:sand_beach", 1, "lib_materials:sand", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, -4, 4, lib_ecology.temperature_cool, lib_ecology.humidity_semihumid)
	...
	add_biome("cool_semihumid_coastal", nil, "lib_materials:dirt_with_grass_cool_semihumid_coastal", 1, "lib_materials:dirt_silty", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_beach, lib_ecology.maxheight_coastal, lib_ecology.temperature_cool, lib_ecology.humidity_semihumid)
	add_biome("cool_semihumid_lowland", nil, "lib_materials:dirt_with_grass_cool_semihumid_lowland", 1, "lib_materials:dirt_dark", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_cool, lib_ecology.humidity_semihumid)
	add_biome("cool_semihumid_shelf", nil, "lib_materials:dirt_with_grass_cool_semihumid_shelf", 1, "lib_materials:dirt", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_cool, lib_ecology.humidity_semihumid)
	add_biome("cool_semihumid_highland", nil, "lib_materials:dirt_with_grass_cool_semihumid_highland", 1, "lib_materials:dirt_clay_red", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_cool, lib_ecology.humidity_semihumid)
...
local add_biomes_cool_temperate = function()
	...
	add_biome("cool_temperate_beach", nil, "lib_materials:sand_beach", 1, "lib_materials:sand", 4, nil, nil, nil, nil, nil, -4, 4, lib_ecology.temperature_cool, lib_ecology.humidity_temperate)
	...
	add_biome("cool_temperate_coastal", nil, "lib_materials:dirt_with_grass_cool_temperate_coastal", 1, "lib_materials:dirt_dark", 4, "lib_materials:stone_limestone_01", nil, nil, nil, nil, lib_ecology.maxheight_beach, lib_ecology.maxheight_coastal, lib_ecology.temperature_cool, lib_ecology.humidity_temperate)
	add_biome("cool_temperate_lowland", nil, "lib_materials:dirt_with_grass_cool_temperate_lowland", 1, "lib_materials:dirt", 4, "lib_materials:stone_limestone_01", nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_cool, lib_ecology.humidity_temperate)
	add_biome("cool_temperate_shelf", nil, "lib_materials:dirt_with_grass_cool_temperate_shelf", 1, "lib_materials:dirt_coarse", 4, "lib_materials:stone_limestone_01", nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_cool, lib_ecology.humidity_temperate)
	add_biome("cool_temperate_highland", nil, "lib_materials:dirt_with_grass_cool_temperate_highland", 1, "lib_materials:dirt_clay_red", 4, "lib_materials:stone_limestone_01", nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_cool, lib_ecology.humidity_temperate)
...
local add_biomes_cool_semiarid = function()
	...
	add_biome("cool_semiarid_beach", nil, "lib_materials:sand_beach", 1, "lib_materials:sand", 4, nil, nil, nil, nil, nil, -4, 4, lib_ecology.temperature_cool, lib_ecology.humidity_semiarid)
	...
	add_biome("cool_semiarid_coastal", nil, "lib_materials:dirt_with_grass_cool_semiarid_coastal", 1, "lib_materials:dirt_sandy", 4, nil, nil, nil, nil, nil, lib_ecology.maxheight_beach, lib_ecology.maxheight_coastal, lib_ecology.temperature_cool, lib_ecology.humidity_semiarid)
	add_biome("cool_semiarid_lowland", nil, "lib_materials:dirt_with_grass_cool_semiarid_lowland", 1, "lib_materials:dirt_coarse", 4, nil, nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_cool, lib_ecology.humidity_semiarid)
	add_biome("cool_semiarid_shelf", nil, "lib_materials:dirt_with_grass_cool_semiarid_shelf", 1, "lib_materials:dirt_clay_red", 4, nil, nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_cool, lib_ecology.humidity_semiarid)
	add_biome("cool_semiarid_highland", nil, "lib_materials:dirt_with_grass_cool_semiarid_highland", 1, "lib_materials:dirt_clayey", 4, nil, nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_cool, lib_ecology.humidity_semiarid)

	add_biome("cool_semiarid_mountain", nil, "lib_materials:stone_granite_01", 10, "lib_materials:stone_brown", 20, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_highland, lib_ecology.maxheight_mountain, lib_ecology.temperature_cool, lib_ecology.humidity_semiarid)
...
local add_biomes_cool_arid = function()
	...
	add_biome("cool_arid_beach", nil, "lib_materials:sand_beach", 1, "lib_materials:sand", 4, nil, nil, nil, nil, nil, -4, 4, lib_ecology.temperature_cool, lib_ecology.humidity_arid)

	add_biome("cool_arid_coastal", nil, "lib_materials:dirt_clay_red", 5, "lib_materials:stone_granite_01", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_beach, lib_ecology.maxheight_coastal, lib_ecology.temperature_cool, lib_ecology.humidity_arid)
	add_biome("cool_arid_lowland", nil, "lib_materials:dirt_clayey", 4, "lib_materials:stone_gabbro", 6, "lib_materials:stone_granite_01", nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_cool, lib_ecology.humidity_arid)
	add_biome("cool_arid_shelf", nil, "lib_materials:sand_desert", 3, "lib_materials:stone_granite_brown", 8, "lib_materials:stone_gabbro", nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_cool, lib_ecology.humidity_arid)
	add_biome("cool_arid_highland", nil, "lib_materials:stone_sandstone_desert_gravel", 2, "lib_materials:stone_andesite", 10, "lib_materials:stone_granite_brown", nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_cool, lib_ecology.humidity_arid)
...
local add_biomes_cold_humid = function()
	...
	add_biome("cold_humid_ocean", nil, "lib_materials:sand_volcanic", 2, "lib_materials:stone_brown", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, -192, -4, lib_ecology.temperature_cold, lib_ecology.humidity_humid)
	add_biome("cold_humid_beach", nil, "lib_materials:dirt_silt_02_with_snow", 1, "lib_materials:stone_brown", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, -4, 4, lib_ecology.temperature_cold, lib_ecology.humidity_humid)
	...
	add_biome("cold_humid_mountain", "lib_materials:snow_block", "lib_materials:ice_default", 10, "lib_materials:stone_brown", 20, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_highland, lib_ecology.maxheight_mountain, lib_ecology.temperature_cold, lib_ecology.humidity_humid)
	add_biome("cold_humid_strato", "lib_materials:ice_default", "lib_materials:ice_default", 15, "lib_materials:stone_granite_02", 25, "lib_materials:stone_brown", nil, nil, nil, nil, lib_ecology.maxheight_mountain, lib_ecology.maxheight_strato, lib_ecology.temperature_cold, lib_ecology.humidity_humid)
...
local add_biomes_cold_semihumid = function()
	...
	add_biome("cold_semihumid_ocean", nil, "lib_materials:sand_volcanic", 2, "lib_materials:stone_brown", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, -192, -4, lib_ecology.temperature_cold, lib_ecology.humidity_semihumid)
	add_biome("cold_semihumid_beach", nil, "lib_materials:dirt_silty_with_snow", 1, "lib_materials:stone_brown", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, -4, 4, lib_ecology.temperature_cold, lib_ecology.humidity_semihumid)
	...
	add_biome("cold_semihumid_mountain", "lib_materials:snow_block", "lib_materials:ice_default", 10, "lib_materials:stone_brown", 20, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_highland, lib_ecology.maxheight_mountain, lib_ecology.temperature_cold, lib_ecology.humidity_semihumid)
	add_biome("cold_semihumid_strato", "lib_materials:ice_default", "lib_materials:ice_default", 15, "lib_materials:stone_granite_02", 25, "lib_materials:stone_brown", nil, nil, nil, nil, lib_ecology.maxheight_mountain, lib_ecology.maxheight_strato, lib_ecology.temperature_cold, lib_ecology.humidity_semihumid)
...
local add_biomes_cold_temperate = function()
	...
	add_biome("cold_temperate_beach", nil, "lib_materials:dirt_dark_with_snow", 1, "lib_materials:sand", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, -4, 4, lib_ecology.temperature_cold, lib_ecology.humidity_temperate)
	...
	add_biome("cold_temperate_mountain", "lib_materials:snow_block", "lib_materials:snow_block", 10, "lib_materials:stone_brown", 20, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_highland, lib_ecology.maxheight_mountain, lib_ecology.temperature_cold, lib_ecology.humidity_temperate)
	add_biome("cold_temperate_strato", "lib_materials:ice_default", "lib_materials:ice_default", 15, "lib_materials:stone_granite_02", 25, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_mountain, lib_ecology.maxheight_strato, lib_ecology.temperature_cold, lib_ecology.humidity_temperate)
...
local add_biomes_cold_semiarid = function()
	...
	add_biome("cold_semiarid_ocean", nil, "lib_materials:sand_silver", 2, "lib_materials:stone_sandstone_silver", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, -192, -4, lib_ecology.temperature_cold, lib_ecology.humidity_semiarid)
	add_biome("cold_semiarid_beach", nil, "lib_materials:dirt_with_snow", 1, "lib_materials:stone_sandstone_silver", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, -4, 4, lib_ecology.temperature_cold, lib_ecology.humidity_semiarid)

	add_biome("cold_semiarid_coastal", nil, "lib_materials:dirt_with_snow", 1, "lib_materials:dirt", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_beach, lib_ecology.maxheight_coastal, lib_ecology.temperature_cold, lib_ecology.humidity_semiarid)
	add_biome("cold_semiarid_lowland", nil, "lib_materials:dirt_with_snow", 1, "lib_materials:dirt_coarse", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_cold, lib_ecology.humidity_semiarid)
	add_biome("cold_semiarid_shelf", nil, "lib_materials:dirt_permafrost", 1, "lib_materials:dirt_clay_red", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_cold, lib_ecology.humidity_semiarid)
	add_biome("cold_semiarid_highland", nil, "lib_materials:dirt_permafrost", 1, "lib_materials:dirt_clayey", lib_ecology.temperature_cold, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_cold, lib_ecology.humidity_semiarid)
...
local add_biomes_cold_arid = function()
	...
	add_biome("cold_arid_ocean", nil, "lib_materials:sand_silver", 2, "lib_materials:stone_sandstone_silver", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, -192, -4, lib_ecology.temperature_cold, lib_ecology.humidity_arid)
	add_biome("cold_arid_beach", nil, "lib_materials:dirt_coarse_with_snow", 1, "lib_materials:stone_sandstone_silver", 4, "lib_materials:stone_basalt_01", nil, nil, nil, nil, -4, 4, lib_ecology.temperature_cold, lib_ecology.humidity_arid)

	add_biome("cold_arid_coastal", nil, "lib_materials:dirt_coarse_with_snow", 8, "lib_materials:stone_granite_01", 10, "lib_materials:stone_basalt_01", nil, nil, nil, nil, lib_ecology.maxheight_beach, lib_ecology.maxheight_coastal, lib_ecology.temperature_cold, lib_ecology.humidity_arid)
	add_biome("cold_arid_lowland", nil, "lib_materials:dirt_permafrost", 8, "lib_materials:stone_gabbro", 10, "lib_materials:stone_granite_01", nil, nil, nil, nil, lib_ecology.maxheight_coastal, lib_ecology.maxheight_lowland, lib_ecology.temperature_cold, lib_ecology.humidity_arid)
	add_biome("cold_arid_shelf", nil, "lib_materials:dirt_permafrost", 8, "lib_materials:stone_granite_brown", 10, "lib_materials:stone_gabbro", nil, nil, nil, nil, lib_ecology.maxheight_lowland, lib_ecology.maxheight_shelf, lib_ecology.temperature_cold, lib_ecology.humidity_arid)
	add_biome("cold_arid_highland", nil, "lib_materials:dirt_permafrost", 8, "lib_materials:stone_granite_02", 15, "lib_materials:stone_granite_brown", nil, nil, nil, nil, lib_ecology.maxheight_shelf, lib_ecology.maxheight_highland, lib_ecology.temperature_cold, lib_ecology.humidity_arid)
...
local add_biomes_generic = function()
	...
	--add_biome("generic_volcanic", nil, "lib_materials:stone_basalt_01_cobble", 1, "lib_materials:stone_basalt_01", 3, "lib_materials:stone_brown", nil, nil, nil, nil, lib_ecology.temperature_temperate, 31000, lib_ecology.temperature_temperate, lib_ecology.humidity_temperate)
	...
	--add_biome("generic_desert", nil, "default:sand", 1, "default:desert_sand", 3, nil, nil, nil, nil, nil, 4, 31000, lib_ecology.temperature_cool, 30)
...
--valleys_c biomes
	...
	add_biome("lib_ecology_coniferous_forest_dunes", nil, "lib_materials:sand", 1, "lib_materials:dirt_silty_with_grass5", 3, nil, nil, nil, nil, nil, 5, 5, 35, 60)
	add_biome("lib_ecology_stone_grassland_dunes", nil, "lib_materials:sand", 1, "lib_materials:sand", 3, nil, nil, nil, nil, nil, 5, 5, 35, 40)
	...
	add_biome("lib_ecology_rainforest_swamp", nil, "lib_materials:dirt_mud_01", 1, "lib_materials:dirt_mud_01", 2, nil, nil, nil, nil, nil, -1, 2, 85, 60)
	...
	add_biome("lib_ecology_savanna_swamp", nil, "lib_materials:dirt_clayey", 1, "lib_materials:dirt_clay_red", 3, nil, nil, nil, nil, nil, -3, 0, 80, lib_ecology.humidity_semiarid)
